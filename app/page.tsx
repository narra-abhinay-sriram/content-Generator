...
export default function Home() {
  const {userId}=auth()
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 overflow-hidden pt-20" >
      <Navbar/>
      ...
      <div className="absolute top-20 left-10 animate-float">
        ...
        <div className="text-center py-20 lg:py-32 relative">
          <RocketIcon className="w-16 h-16 text-purple-600 mx-auto mb-6 animate-bounce" />
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-900">
          ...
          <Button
              asChild
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full text-lg transition duration-300 ease-in-out  hover:scale-105"
            >
              <Link href="/generate">Start Creating</Link>
            </Button>
            <Button asChild className="bg-transparent border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-full text-lg transition duration-300 ease-in-out">
          ...
          <div className="py-20" id="features">
            <h2 className="text-3xl font-bold mb-16 text-center text-white">
              Supercharge your social media presense
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
              {
                [{
                  title: "Twitter Threads",
                  icon: <BirdIcon className="w-10 h-10 mb-4 text-blue-400" />,
                  description:
                ...
                },
                {
                  ...
                  <div key={index} className="p-8 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1"
>                     <div className="flex flex-col items-center text-center">
        ...
        <div className="py-20 bg-gray-900 rounded-3xl my-20 relative">
          ...
          {
            userId ? (<Button asChild className="bg-blue-600 hover:bg-blue-900 text-white px-14 rounded-full text-lg  py-2 transition duration-200 hover:scale-100 ">
              <Link href={'/generate'}>
